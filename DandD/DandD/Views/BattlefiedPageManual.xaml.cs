...
namespace DandD.Views
{
    ...
    public partial class BattlefiedPageManual : ContentPage
    {
        ...
        public async void playGame()
        {
            ...
            while (totalHP > 0)
            {
                ...
                else
                {
                    ...
                    await App.Database.UpdateCharacter(c1);
                    //c.Remove(c[i]);
                    System.Diagnostics.Debug.WriteLine("deleted dead character from local list");
                }
                ...
                else
                {
                    ...
                    await App.Database.InsertMonster(m1); //Updating current monster
                    //m.Remove(m1);
                    System.Diagnostics.Debug.WriteLine("deleted dead monster from local list");
        ...
        {
            var answer = await DisplayAlert("Round Finished", "Moving on", "Ok", "Continue");
